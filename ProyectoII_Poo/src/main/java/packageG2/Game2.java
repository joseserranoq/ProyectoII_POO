...
public class Game2 extends javax.swing.JInternalFrame implements GameFunction {
    private String[] arr;   //it will have the rock paper scissors as a strings
    /*
    ...
    private void initComponents() {
        ...
        Panel1.add(labelRes, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 260, 180, 20));
    ...
    private void bRockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRockActionPerformed
        // TODO add your handling code here:
         //if the choice of the user is rock, it looks if the user has a win, lose or tie
        startG();
    ...
    private void bPaperActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bPaperActionPerformed
        // TODO add your handling code here:
         //if the choice of the user is paper, it looks if the user has a win, lose or tie
        startG();
                String r =labelRival.getText();
        if(r == "Paper"){
            labelRes.setText("It is tie, keep playing");
    ...
    private void bScissorsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bScissorsActionPerformed
        // TODO add your handling code here:
        //if the choice of the user is scissors, it looks if the user has a win, lose or tie
        startG();
                String r =labelRival.getText();
        if(r == "Scissors"){
            labelRes.setText("It is tie, keep playing");
    ...
    @Override
    public void startG() {  //it generates the rival random choice
    ...
    @Override
    public Stat getStats() {    // it will get the points
                Stat stat;
